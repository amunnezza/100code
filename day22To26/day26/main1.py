...
lista1_num = [int(num.strip()) for num in lista1 ]
lista2_num = [int(num.strip()) for num in lista2]
# print (lista1)
# print (lista1_num)
# print (lista2)
# print (lista2_num)
result = [num for num in lista1_num if (num in lista2_num)]
print (result)
file1.close()
file2.close()
#in realta strip e conversioni inutili
