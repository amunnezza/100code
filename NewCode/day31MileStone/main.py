...
card_front_img = PhotoImage(working_dir +"/images/card_front.png") #6 prepari immagine
...
cross_image = PhotoImage(file=working_dir +"/images/wrong.png") #11 crea image da mettere nel button
unknown_button = Button(image=cross_image)  #12 fa  il button
unknown_button.grid(row=1, column=0)#posiziona

check_image = PhotoImage(file=working_dir+"/images/right.png") #13 stesso discorso per il medesimo button
